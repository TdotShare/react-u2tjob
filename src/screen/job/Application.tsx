                    ...
                    <Paper sx={{ maxWidth: 1200, margin: 'auto', overflow: 'hidden', mt: 2 }}>
                        ...
                        <Container >
                            ...
                            <Box component="form" onSubmit={handleSubmit} noValidate >
                                ...
                                <Box sx={{ p: '2%', mt: 2 }}>
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid0)} files={evid0} setphoto={data?.data.job.evid0 ? true : false} shotnamefile='ภาพถ่ายผู้มัคร' title={`ภาพถ่ายผู้มัคร (ถ่ายไว้ไม่เกิน 3 เดือน)`} fileData={(data: File) => setEvid0(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid1)} files={evid1} setphoto={data?.data.job.evid1 ? true : false} shotnamefile='หนังสือรับรองคุณวุติ' title={`สำเนาปริญญาบัตร หรือ หนังสือรับรองคุณวุติ`} fileData={(data: File) => setEvid1(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid2)} files={evid2} setphoto={data?.data.job.evid2 ? true : false} shotnamefile='Transcript' title={`Transcript`} fileData={(data: File) => setEvid2(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid3)} files={evid3} setphoto={data?.data.job.evid3 ? true : false} shotnamefile='สำเนาหลักฐานการเปลี่ยนชื่อสกุล' title={`สำเนาหลักฐานการเปลี่ยนชื่อสกุล (ถ้ามี)`} fileData={(data: File) => setEvid3(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid4)} files={evid4} setphoto={data?.data.job.evid4 ? true : false} shotnamefile='สำเนาบัตรประชาชน' title={`สำเนาบัตรประชาชน`} fileData={(data: File) => setEvid4(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid5)} files={evid5} setphoto={data?.data.job.evid5 ? true : false} shotnamefile='สำเนาทะเบียนบ้าน' title={`สำเนาทะเบียนบ้าน`} fileData={(data: File) => setEvid5(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid6)} files={evid6} setphoto={data?.data.job.evid6 ? true : false} shotnamefile='สำเนาหลักฐานการเกณฑ์ทหาร' title={`สำเนาหลักฐานการเกณฑ์ทหาร`} fileData={(data: File) => setEvid6(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid7)} files={evid7} setphoto={data?.data.job.evid7 ? true : false} shotnamefile='ใบรับรองพื้นที่' title={`ใบรับรองพื้นที่`} fileData={(data: File) => setEvid7(data)} />
                                    <InputUploadFile urlData={() => actionUrlOpen(data?.data.job.evid8)} files={evid8} setphoto={data?.data.job.evid8 ? true : false} shotnamefile='เอกสารอื่นๆ' title={`เอกสารอื่นๆ`} fileData={(data: File) => setEvid8(data)} />
                                </Box>
